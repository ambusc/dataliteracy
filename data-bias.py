...
st.caption(:red['10 minute read. For questions contact Jordan @ DataGovernance@perkinscoie.com'])
...
''
st.text('__Selection Bias__ occurs when the sample was collected in an inaccurate or biased way.')
''
...
''
st.text('__Reporting Bias__ happens when certain data is withheld from an analysis.')
...
''
st.text('__System Drift__ occurs when the definition of a term changes over time.')
''
